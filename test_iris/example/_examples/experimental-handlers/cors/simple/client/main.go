...
// It is just an example of communication between cors/simple/main_test.go and your app
...
// exposes the cors/simple/main_test.go server side.
...
func main() {
	...
	// and go to the previous terminal of your running cors/simple/main_test.go server
	// and see the logs.
